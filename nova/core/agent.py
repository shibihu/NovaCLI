...
This module is the single implementation of agent behaviour. Both CLI and Web IDE
drive :class:`NovaAgent`.
"""
...
from .parser import AgentDecision, extract_json_object, parse_agent_response
